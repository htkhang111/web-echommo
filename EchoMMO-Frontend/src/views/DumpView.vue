...
.page-title {
  margin: 0; font-size: 1.8rem; color: #ffecb3;
  text-shadow: 0 2px 4px rgba(0,0,0,0.8);
}
.subtitle {
  font-style: italic; opacity: 0.8; font-size: 0.9rem; color: #d7ccc8;
}
.btn-back {
  background: transparent; border: 1px solid #8d6e63;
  color: #d7ccc8; padding: 5px 15px; border-radius: 4px;
...
.fish-option.active {
  border-color: #66bb6a; background: rgba(74, 222, 128, 0.1);
  box-shadow: 0 0 10px rgba(102, 187, 106, 0.2);
}
.fish-option.shark.active {
  border-color: #ef5350; background: rgba(248, 113, 113, 0.1);
...
.number-input {
  ...
  font-size: 1.2rem; font-weight: bold; width: 80px;
...
.slider {
  width: 100%; height: 6px; accent-color: #ffd700;
...
.btn-mini {
  ...
  color: #d7ccc8; padding: 8px 5px; border-radius: 4px;
...
.btn-dump {
  ...
  border: 1px solid #43a047; border-radius: 6px;
...
.result-modal {
  ...
  display: flex; align-items: center; justify-content: center;
  z-index: 100; animation: fadeIn 0.3s; backdrop-filter: blur(4px);
}
.modal-content {
  background: #261815; padding: 30px; border-radius: 8px;
  width: 90%; max-width: 400px; text-align: center;
  border: 2px solid #ffd700; box-shadow: 0 0 30px rgba(0,0,0,0.8);
}
.modal-content h3 {
  color: #ffd700; margin-top: 0;
...
.reward-item {
  ...
  gap: 15px; border: 1px solid #4e342e; transition: transform 0.2s;
}
.reward-item:hover { transform: translateX(5px); background: rgba(255,255,255,0.08); }

/* Item Icon Wrapper - Fix Size */
.item-icon-wrapper {
...
.reward-item.mythic {
  border-left: 4px solid #ef5350; background: rgba(239, 83, 80, 0.1);
  box-shadow: 0 0 10px rgba(239,83,80,0.3);
}

.btn-close {
  background: #3e2723; color: #ffd700; border: 1px solid #5d4037;
