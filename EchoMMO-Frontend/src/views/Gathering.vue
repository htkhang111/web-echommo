...
// [FIX] Cập nhật tên ảnh đúng với Assets trên Git
const EVENT_TYPES = [
  // GỖ (w_)
  { id: "wood", rewardItemId: 1, name: "Cây Gỗ Sồi", image: resolveItemImage("w_wood.png"), rarityClass: "common", rarityText: "Phổ Thông", reqLevel: 1, reqTool: "Rìu", lootName: "Gỗ Sồi" },
  { id: "dried_wood", rewardItemId: 2, name: "Cây Gỗ Khô", image: resolveItemImage("w_wood-red.png"), rarityClass: "common", rarityText: "Phổ Thông", reqLevel: 1, reqTool: "Rìu", lootName: "Gỗ Khô" },
  { id: "cold_wood", rewardItemId: 3, name: "Cây Gỗ Lạnh", image: resolveItemImage("w_wood-white.png"), rarityClass: "uncommon", rarityText: "Ít Gặp", reqLevel: 10, reqTool: "Rìu Sắt", lootName: "Gỗ Lạnh" },
  { id: "strange_wood", rewardItemId: 4, name: "Cây Gỗ Lạ", image: resolveItemImage("w_wood-black.png"), rarityClass: "rare", rarityText: "Hiếm", reqLevel: 20, reqTool: "Rìu Chiến", lootName: "Gỗ Lạ" },
  
  // KHOÁNG SẢN (o_)
  { id: "stone", rewardItemId: 5, name: "Mỏ Đá", image: resolveItemImage("o_coal.png"), rarityClass: "common", rarityText: "Phổ Thông", reqLevel: 1, reqTool: "Búa", lootName: "Đá/Than" },
  { id: "copper", rewardItemId: 6, name: "Mạch Đồng", image: resolveItemImage("o_copper.png"), rarityClass: "common", rarityText: "Phổ Thông", reqLevel: 5, reqTool: "Cuốc", lootName: "Quặng Đồng" },
  { id: "iron", rewardItemId: 7, name: "Mỏ Sắt", image: resolveItemImage("o_iron.png"), rarityClass: "rare", rarityText: "Hiếm", reqLevel: 20, reqTool: "Cuốc Sắt", lootName: "Quặng Sắt" },
  { id: "platinum", rewardItemId: 8, name: "Tinh Thể Bạch Kim", image: resolveItemImage("o_platinum.png"), rarityClass: "epic", rarityText: "Cực Phẩm", reqLevel: 40, reqTool: "Găng Tay", lootName: "Bạch Kim" },
  
  // CÁ (f_)
  { id: "fish", rewardItemId: 9, name: "Hồ Cá", image: resolveItemImage("f_fish.png"), rarityClass: "common", rarityText: "Phổ Thông", reqLevel: 1, reqTool: "Cần Câu", lootName: "Cá" },
  { id: "shark", rewardItemId: 10, name: "Vùng Nước Nguy Hiểm", image: resolveItemImage("f_shark.png"), rarityClass: "uncommon", rarityText: "Nguy Hiểm", reqLevel: 30, reqTool: "Cần Câu Máy", lootName: "Cá Mập" },
  
  // KHÁC (r_)
  { id: "coin", rewardItemId: 11, name: "Kho Báu Cổ", image: resolveItemImage("r_coinEcho.png"), rarityClass: "legendary", rarityText: "Huyền Thoại", reqLevel: 50, reqTool: "Tay Không", lootName: "Echo Coin" },
  { id: "unknown", rewardItemId: 12, name: "Vật Thể Lạ", image: resolveItemImage("o_strange.png"), rarityClass: "epic", rarityText: "Bí Ẩn", reqLevel: 45, reqTool: "Găng Tay", lootName: "Nguyên liệu lạ" }
];
...
const initEvent = () => {
  ...
  if (evt) {
    ...
    // Fallback nếu không tìm thấy ID khớp
...
const handleGather = async (times = 1) => {
  ...
  try {
    ...
    if (!charId) {
      throw new Error("Không tìm thấy ID nhân vật");
    }
    ...
    if (e.response && e.response.data && e.response.data.message) {
        ...
        feedbackMsg.value = "Khai thác thất bại (Lỗi Server)";
    }
  } finally {
