...
VALUES (1, 'Gỗ Sồi', 'MATERIAL', 'COMMON', 1, 10, 'Gỗ thông thường.', 'w_wood.png', 'MATERIAL'),
       ...
       -- [FIX] Đổi Đá -> Than (Map vào cột stone trong Wallet)
       (5, 'Than', 'MATERIAL', 'COMMON', 1, 5, 'Nhiên liệu đen dùng để nung nấu.', 'o_coalOre.png', 'MATERIAL'),

       -- [FIX] Sửa ảnh Quặng Đồng (trước đây bị nhầm là iron)
       (6, 'Quặng Đồng', 'MATERIAL', 'COMMON', 1, 10, 'Nguyên liệu đúc đồng.', 'r_copper_bar.png', 'MATERIAL'),
...
-- =========================================================
-- Tạo tài khoản Admin (Mật khẩu hash là 123456)
INSERT INTO users (username, password_hash, password, email, full_name, role, avatar_url)
VALUES ('admin', '$2a$10$wPOKcn9CM0dlp.k83kEHne1UU90Y5.RL2MaLkqwJ0ZRnN3IbsRnnS', '123456', 'admin@echommo.com', 'Trời',
        'ADMIN', '🐲');

-- Tạo Wallet (Cột stone sẽ chứa số lượng Than)
...
-- Trang bị Admin (Đã check ID tồn tại)
