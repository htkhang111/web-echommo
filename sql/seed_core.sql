...
-- =========================================================
-- 1. ITEMS: RESOURCES (Mapping chuẩn theo Git assets)
-- =========================================================
...
VALUES (1, 'Gỗ Sồi', 'MATERIAL', 'COMMON', 1, 10, 'Gỗ thông thường.', 'w_wood.png', 'MATERIAL'),
       ...
       (4, 'Gỗ Hắc Ám', 'MATERIAL', 'MYTHIC', 5, 500, 'Gỗ đen tuyền, có tỷ lệ rơi Echo.', 'w_woodBlack.png',
        'MATERIAL');

-- KHOÁNG SẢN (ID 5-8, 12, 14)
-- [FIX] ID 5 là Than (Coal), dùng ảnh o_coalOre.png
INSERT INTO items (item_id, name, type, base_rarity, tier, base_price, description, image_url, slot_type)
VALUES (5, 'Than', 'MATERIAL', 'COMMON', 1, 5, 'Nhiên liệu đen dùng để nung nấu.', 'o_coalOre.png', 'MATERIAL'),
       (6, 'Quặng Đồng', 'MATERIAL', 'COMMON', 1, 10, 'Nguyên liệu đúc đồng.', 'o_copperOre.png', 'MATERIAL'),
       ...
       (12, 'Nguyên liệu lạ', 'MATERIAL', 'MYTHIC', 5, 1000, 'Vật phẩm bí ẩn, có tỷ lệ rơi Echo.', 'o_strangeOre.png',
        'MATERIAL'),
       (14, 'Mỏ Vàng', 'MATERIAL', 'LEGENDARY', 1, 0, 'Chứa đầy vàng ròng. Đào là có tiền!', 'o_goldOre.png',
        'MATERIAL');

-- THỦY SẢN (ID 9, 10, 13)
INSERT INTO items (item_id, name, type, base_rarity, tier, base_price, description, image_url, slot_type)
VALUES (9, 'Cá', 'MATERIAL', 'COMMON', 1, 10, 'Cá sông tươi ngon.', 'r_fish.png', 'MATERIAL'),
       (10, 'Cá Mập', 'MATERIAL', 'UNCOMMON', 2, 100, 'Thịt cá mập bổ dưỡng.', 'r_fishShark.png', 'MATERIAL'),
       (13, 'Megalodon', 'MATERIAL', 'MYTHIC', 5, 2000, 'Quái vật tiền sử, có tỷ lệ rơi Echo.', 'f_fishMegalodon.png',
        'MATERIAL');

-- TIỀN TỆ ĐẠI DIỆN (ID 11)
INSERT INTO items (item_id, name, type, base_rarity, tier, base_price, description, image_url, slot_type)
VALUES (11, 'Echo Coin', 'MATERIAL', 'LEGENDARY', 5, 1000, 'Đồng xu quyền năng.', 'r_coinEcho.png', 'MATERIAL');
...
-- [FIXED] Wallet: Đổi cột 'stone' thành 'coal' (1000 than)
